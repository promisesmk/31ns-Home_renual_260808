...
const i18n = {
  ko: {
    ...
    cap0Title: "2.4GHz 멀티벤더 칩·모듈 개발",
    cap0Sub: "Nordic · TI · Silicon Labs · Espressif · NXP · Telink",
    cap0Desc: "Nordic nRF 시리즈로 20년간 축적한 RF 설계 역량으로, 벤더를 가리지 않고 2.4GHz 칩과 모듈로 제품을 완성합니다. 신규 벤더 칩이 나와도 단기간 숙지 후 즉시 개발합니다.",
  ...
  en: {
    ...
    cap0Title: "2.4GHz Multi-Vendor Chip & Module Engineering",
    cap0Sub: "Nordic · TI · Silicon Labs · Espressif · NXP · Telink",
